...
const Dashboard = () => {
    ...
    return (
        ...
        <p>&copy; {new Date().getFullYear()} Your School Name. All rights reservedaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.</p>
      </footer>
      </div>
                <hr style={styles.divider} />
...
const styles = {
    ...
    footercontainer: {
        ...
        alignItems: 'center',
        padding: '20px',
        backgroundColor: '#f4f4f4', // Light background color for the footer container
      },
      ...
      footerr: {
        ...
        padding: '10px 0',
        backgroundColor: '#0e4296', // Dark blue background
        color: '#fff', // White text
        fontSize: '130px', // Sets a smaller font size
        borderTop: '1px solid #ccc', // Light gray border at the top of the footer
